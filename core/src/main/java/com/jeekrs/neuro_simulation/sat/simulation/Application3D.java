package com.jeekrs.neuro_simulation.sat.simulation;
...
import com.jeekrs.neuro_simulation.sat.simulation.WrappedCubeModel.CubeInstance;
	...
	private void renderText()
	{
		...
		else
		{
			 bmFont.draw(spriteBatch, "No detected collisions", Gdx.graphics.getWidth() / 2
					 - bmFont.getSpaceXadvance() * "No detected collisions".length() //approximately center this text
